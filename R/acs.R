...
if (!isGeneric("endyear")) {
    setGeneric("endyear", def = function(object) {
        standardGeneric("endyear")
    })
} else {
}
setMethod("endyear", "acs.lookup", function(object) object@endyear)
if (!isGeneric("span")) {
    setGeneric("span", def = function(object) {
...
if (!isGeneric("results")) {
    setGeneric("results", def = function(object) {
...
if (!isGeneric("geography")) {
    setGeneric("geography", def = function(object) {
...
if (!isGeneric("acs.colnames")) {
    setGeneric("acs.colnames", def = function(object) {
...
if (!isGeneric("currency.year")) {
    setGeneric("currency.year", def = function(object) {
...
if (!isGeneric("modified")) {
    setGeneric("modified", def = function(object) {
        standardGeneric("modified")
    })
} else {
}
