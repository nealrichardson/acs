...
#' recursively prowl through a geo.set and return a single flat geo.set (one
#' level deep) containing of the composite geographies.
#' 
#' 
#' @param x the geo.set to be flattened
#' @return Returns a new geo.set object.
